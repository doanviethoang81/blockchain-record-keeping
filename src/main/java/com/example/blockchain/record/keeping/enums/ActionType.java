...
public enum ActionType {
    ...
    LOCK_READ("Khóa quyền đọc của"),
    UNLOCK_READ("Mở khóa quyền đọc của"),
    LOCK_CREATE("Khóa quyền tạo của"),
    UNLOCK_CREATE("Mở khóa quyền tạo của"),
    LOCK_UPDATE("Khóa quyền sửa của"),
    UNLOCK_UPDATE("Mở khóa quyền sửa của"),
    LOCK_DELETE("Khóa quyền xóa của"),
    UNLOCK_DELETE("Mở khóa quyền xóa của"),
